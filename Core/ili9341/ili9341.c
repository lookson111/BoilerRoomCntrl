...
uint8_t frm_buf[QUANTPIXELLINE*2] = {0};

void init_ILI9341(SPI_HandleTypeDef *hspi) {
	ILI9341_SPI_PORT = hspi;
}
...
void ILI9341_FillScreen(uint16_t color) {
  ...
  dma_spi_cnt = QUANTLINES;
  HAL_SPI_Transmit_DMA(ILI9341_SPI_PORT, frm_buf, n);
  while(!dma_spi_fl) {}
  dma_spi_fl=0;
